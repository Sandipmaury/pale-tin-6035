  ...
  return (
    <Box>
      ...
      <Box
        ...
        fontSize='17px'
      >
        <NavLink to='#'><Image src={state.data[0].urlToImage} /></NavLink>
        ...
        <UnorderedList>
            ...
            <NavLink to='#' color='white'>{state.data[1].title}</NavLink>
            </ListItem>
        ...
        <Flex color={darkMode.color === 'white' ? 'red': "blue"}
         fontSize='13px' flexDirection='row-reverse'><NavLink to='#'>MORE FROM MOVIES > </NavLink></Flex>
      </Box>
    </Box>
  );
}
